...
function renderFooter() {
  ...
  const sellerLinkHTML = isSeller 
    ? `<li><a href="dashboard.html" style="color: #E5DFD6; font-weight: 600;">Panel de Vendedor</a></li>`
    : `<li><a href="login.html" style="color: #E5DFD6; font-weight: 600;">¿Eres artesano? Vende aquí</a></li>`;

  const html = `
    <footer class="main-footer" style="background-color: #0F3D2E; color: #FAF6F0;">
      <!-- Newsletter Bar with background image -->
      <div class="footer-newsletter-bar" style="background-image: linear-gradient(rgba(15, 61, 46, 0.92), rgba(15, 61, 46, 0.92)), url('img/hero_artesanias.png'); background-size: cover; background-position: center; border-bottom: 1px solid rgba(235, 220, 185, 0.1);">
      ...
      <div class="footer-body">
        <div class="footer-brand-column">
          <div class="footer-brand-title" style="display: flex; align-items: center; gap: 0.5rem;">
            <img src="img/logo-vasija.svg" alt="Logo de Artesanías Chigorodó" style="width: 32px; height: 32px;" />
          ...
          <div class="social-links" style="display: flex; gap: 1rem; marginTop: 1.25rem;">
        ...
        <div class="footer-links-column">
          <h4 style="color: #FAF6F0; font-weight: 700; marginBottom: 1.25rem;">Información</h4>
          <ul style="list-style: none; padding: 0;">
            <li><a href="productos.html" style="color: #E5DFD6;">Sobre nosotros</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Nuestros artesanos</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Blog de cultura</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Preguntas frecuentes</a></li>
            ${sellerLinkHTML}
          </ul>
        </div>

        <div class="footer-links-column">
          <h4 style="color: #FAF6F0; font-weight: 700; marginBottom: 1.25rem;">Ayuda</h4>
          <ul style="list-style: none; padding: 0;">
            <li><a href="productos.html" style="color: #E5DFD6;">Envíos y entregas</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Devoluciones y garantías</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Métodos de pago</a></li>
            <li><a href="productos.html" style="color: #E5DFD6;">Contacto</a></li>
          </ul>
        </div>

        <div class="footer-links-column">
          <h4 style="color: #FAF6F0; font-weight: 700; marginBottom: 1.25rem;">Medios de pago</h4>
