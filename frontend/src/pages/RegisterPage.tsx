      ...
      <div className="auth-card-container">
        ...
        <div className="auth-columns">
          ...
          <div className="auth-column">
            <div className="auth-column-title inactive" style={{ color: 'var(--primary)' }}>
              <User size={20} />
          ...
          {/* Column 2: Register */}
          <div className="auth-column">
            <div className="auth-column-title active" style={{ borderBottomColor: 'var(--secondary)', color: 'var(--secondary)' }}>
              <UserPlus size={20} />
